...
$sql=pg_query("select * from reservoir_level_sdp order by id asc"); 
...
$fp = fopen('uploads_csv/reservoir_level_sdp.json', 'w');
//if (!$fp) die("FFF");
fwrite($fp, json_encode($response));
...
<table width="100%" style="vertical-align:middle; text-align:center">
  <tr>
    ...
    <td><input name="c" class="fetchSeries" type="button" value="Reservoir volume Dynamic Programming" lnk="uploads_csv/reservoir_level_dp.json"></td>
     <td><input name="d" class="fetchSeries" type="button" value="Reservoir volume Stohastic Dynamic Programming" lnk="uploads_csv/reservoir_level_sdp.json"></td>
    <td><input name="e" class="fetchSeries" type="button" value="Reservoir volume Reinforcement Learning" lnk="uploads_csv/reservoir_level_rl.json"></td>
  </tr>
  <tr>
    ...
    <td><a onclick="NoCache('uploads_csv/reservoir_level_dp.json')" href="#">Reservoir level data</a></td>
     <td><a onclick="NoCache('uploads_csv/reservoir_level_sdp.json')" href="#">Reservoir level data</a></td>
